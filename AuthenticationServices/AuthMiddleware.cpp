...
QHttpServerResponse Middleware::checkingToken_O1(const QHttpServerRequest &request)
    {
...
QHttpServerResponse Middleware::checkingToken_O2(const QHttpServerRequest &request)
    {
        QList<std::pair<QByteArray, QByteArray>> headers = request.headers();
        //Lấy token từ header
